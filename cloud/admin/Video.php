                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <form enctype='multipart/form-data' action='upload_ok.php' method='post' class="form-horizontal mt-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            <input name='myfile' type="file" class="custom-file-input" id="inputGroupFile01">
