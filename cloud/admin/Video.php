                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <form enctype='multipart/form-data' action='Video_ok.php' method='post' class="form-horizontal mt-4">
							<input type="hidden" name="MAX_FILE_SIZE" value="1000000">
                                <div class="form-group">
                                <label>Custom File upload</label>

                                <div class="form-group">
                                    <label>비디오 <span class="help">일련번호</span></label>
                                    <input type="text" name="VIDEO_SEQ" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>비디오 이름</label>
                                ...
                                <div class="form-group">
                                    <label>비디오 주제</label>
                                    <textarea class="form-control" name="VIDEO_SUBJECT" rows="5"></textarea>
                                </div>   
							
                                <div class="form-group">
                                    <fieldset disabled>
                                        <label for="disabledTextInput">관리자 명</label>
                                        <input type="text" id="VIDEO_ADMIN " name="VIDEO_ADMIN" class="form-control"
                                            placeholder="ADMIN">
                                    </fieldset>
                                </div>                    
                                <div class="form-group">
